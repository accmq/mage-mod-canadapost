...
namespace ACCMQ\CanadaPost\Setup;
...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $select = $conn->select()->from(
            ...
            'path IN (?)',
            [
                'carriers/canadapost/packaging',
                'carriers/canadapost/dropoff',
                'carriers/canadapost/free_method',
                'carriers/canadapost/allowed_methods'
            ]
        );
